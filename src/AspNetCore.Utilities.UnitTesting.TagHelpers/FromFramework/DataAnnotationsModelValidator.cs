// <auto-generated>
// Copied from https://github.com/dotnet/aspnetcore/blob/v6.0.6/src/Mvc/Mvc.DataAnnotations/src/DataAnnotationsModelValidator.cs
// Standard Changes:
//  - Pulling out global usings
//  - Using file scoped namespaces
//  - Changing of the namespace
// File Specific:
//  - Replaced Resources.FormatPropertyOfTypeCannotBeNull call with formatted string. 
// </auto-generated>
...
internal class DataAnnotationsModelValidator : IModelValidator
{
    ...
    public IEnumerable<ModelValidationResult> Validate(ModelValidationContext validationContext)
    {
        ...
        {
            // ICG-MS: Replaced Resources.FormatPropertyOfTypeCannotBeNull call with formatted string
            throw new ArgumentException($"Property '{nameof(validationContext)}.{nameof(validationContext.ModelMetadata)}' of type '{typeof(ModelValidationContext)}' cannot be null");
        }
